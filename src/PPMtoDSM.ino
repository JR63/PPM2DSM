...
#define THROTTLE_CHANNEL	3					// choose your throttle channel
...
static State_t State;							// this will be one of the following states: NULL_ST, NOT_SYNCHED, ACQUIRING, READY, FAILSAFE
